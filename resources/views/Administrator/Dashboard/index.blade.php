    ...
    @endif
       ...
       <div class="row items-align-baseline ">
                    ...
                    <div class="card-body mb-n3">
                      <div class="row items-align-baseline h-100">
                        <div class="col-md-12 my-3">
                          <h3 class="text-md">Total Upload Berita Hari Ini </h3>
                        </div>
                     
                        <div class="col-md-6 border-top py-3">
                          <p class="mb-1"><strong class="text-muted">Berita Yang Sedang Tayang</strong></p>
                          <h4 class="mb-0">{{$berita['total_berita_tayang']}}</h4>
                        </div> <!-- .col -->
                        <div class="col-md-6 border-top py-3">
                          <p class="mb-1"><strong class="text-muted">Berita yang Di Trash Bin</strong></p>
                          <h4 class="mb-0">{{$berita['total_berita_terhapus']}}</h4>
                        </div> <!-- .col -->
                      </div>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                ...
                <div class="col-md-12 col-lg-4">
                  <div class="card shadow eq-card mb-4">
                    <div class="card-body">
                        <h2>TOTAL JURNALIS</h2>
                      <div class="row items-align-center">
                        <div class="col-12 text-center">
                          <p class="text-muted mb-1">Aktif</p>
                          <h6 class="mb-1">{{$jurnalis}}</h6>
                        </div>
                      </div>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
